...
- Tutorial de HTML en W3Schools.[^w3s]
- Tutorial de HTML en HTML.net.[^html]

Recuerda que hay varias versiones de HTML. Este tutorial trata de cubrir los primeros conceptos de HTML 4.1, con algunas recomendaciones típicas de versiones más modernas como XHTML 1.0[^xhtml1]. 

Si encuentras tutoriales modernos es posible que hagan referencia a HTML5, la última y más moderna versión de HTML. *Todavía* no nos interesa esta versión.
...
```html
	<head>
        ...
        <title>Hipertexto y Multimedia: tutorial de HTML</title> 
...
Podemos inclur [imágenes](http://www.w3schools.com/html/html_images.asp) a través del elemento `img`. Dicho elemento es vacío, no etiqueta nada, por lo debemos utilizar una única etiqueta.
...
Para etiquetar [enlaces](http://www.w3schools.com/html/html_links.asp) (o vínculos) utilizamos el elemento `a` (*anchor*) junto con:
...
```html
    <p>Escucha <a href="http://snd.sc/XVjH83">mi canción favorita</a> 
    de esta semana.</p>

    <p>O disfrútala directamente desde aquí: </p>
    <iframe width="100%" height="166" scrolling="no" frameborder="no" 
    src="https://w.soundcloud.com/player/?url=
    http%3A%2F%2Fapi.soundcloud.com%2Ftracks%2F76331890">
    </iframe>
```

¡OJO! [`iframe`](http://www.w3schools.com/html/html_iframe.asp) es un elemento especial que nos permite incrustar un documento HTML completo dentro de otro documento HTML.
...
```html
    <p>Haz clic en <a href="http://www.youtube.com/watch?v=Y7DQRxV3mV8">
    mi vídeo favorito</a>.</p>
	
    <p>O visualízalo directamente aquí:</p>
    
    <iframe width="560" height="315" 
    src="http://www.youtube.com/embed/Y7DQRxV3mV8" frameborder="0" 
    allowfullscreen></iframe>
```


- [^w3s]: http://www.w3schools.com/html/default.asp
- [^html]:  http://es.html.net/tutorials/html/
- [^xhtml1]: http://www.w3schools.com/html/html_xhtml.asp
