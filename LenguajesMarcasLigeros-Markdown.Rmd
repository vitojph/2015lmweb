...
Markdown es un lenguaje de marcas ligero que recientement ha adquirido mucha popularidad como lenguaje de marcas en blogs (Wordpress[^wordpress] lo utiliza por defecto) y como lenguaje para la documentación de proyectos de software libre. Desafortunadamente, no existe una versión estandarizada de Markdown, y hay varias versiones[^sabores], que no siempre funcionan en todas las plataformas.
...
[^fuente]: https://raw.githubusercontent.com/vitojph/2015lmweb/master/LenguajesMarcasLigeros-Markdown.Rmd
