...
- Configura el modo de edición como **MediaWiki** y elabora una entrada a modo de página de presentación demostrando que eres capaz de manejarte con las reglas de sintaxis básicas de Wiki Markup. No es necesario que la información sea verdad, puedes crearte un *alter ego* si lo prefieres.

- A medida que vayas añadiendo información, previsualiza el resultado final pulsando ne **Preview**. Vuelve a **Write** para seguir editando.
